...
public PatientData(String cpr,String illnesses,String alegies,int height,int weight,boolean isSmoker,String vaccines,
		String familyIllnesses,boolean insurance,boolean pregnancy){
this.cpr=cpr;
