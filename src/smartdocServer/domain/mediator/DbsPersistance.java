...
public interface DbsPersistance {
	...
	/**
	 * Verifies if the account of specific login and password exists in the database, if not returns 0, if it does returns 
	 * cpr number of the person who this account belong to
	 * @param login
	 * @param password
	...
	/**
	 * Look for a matching cpr result in the database and returns that row as an array of objects in an ArrayList which contains one result
	 * @param cpr
	 * @return
	 */
	...
	/**
	 * Looks for a matching cpr result in the database and returns that row as an array of objects in an ArrayList which contains one result
	 * @param cpr
	 * @return
	 */
